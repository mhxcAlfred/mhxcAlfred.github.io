...
function() {
    ...
    var r = t(function(e, t) {
        ...
        t.Sensor = function e(t) {
            ...
            this.createSensor = function() {
                ...
                return e.onload = function() {
                    e.contentDocument.defaultView.addEventListener("resize", n.resizeListener),
                    n.resizeListener()
                },
        ...
        default)(function() {
            ...
            this.bind = function(e) {
                n.sensor || (n.sensor = n.createSensor()),
                -1 === n.listeners.indexOf(e) && n.listeners.push(e)
            },
            this.unbind = function(e) {
                var t = n.listeners.indexOf(e); - 1 !== t && n.listeners.splice(t, 1),
                0 === n.listeners.length && n.sensor && n.destroy()
            },
    ...
    var a = t(function(e, t) {
        ...
        t.clear = function(e) {
            var t = (0, s.getSensor)(e); (0, s.removeSensor)(t)
        }
    });
    e(a);
    var u = a.clear,
    l = a.bind,
    c = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || window.oRequestAnimationFrame ||
    function(e) {
        ...
        return v(e, [{
            ...
            value: function() {
                ...
                window.onmousemove = function(t) {
                    e.current.x = t.clientX - e.el.offsetLeft,
                    e.current.y = t.clientY - e.el.offsetTop,
